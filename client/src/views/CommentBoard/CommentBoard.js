...
const useStyles1 = makeStyles((theme) => ({
  ...
  function CommentBoard() {
    ...
    const options = [
      { key: 'thomas', text: 'Dr. Sanethia Thomas', value: 'Dr. Sanethia Thomas' },
    ...
    <div>
      ...
      <div text-align = "center" class="ui action input"><input type="text" placeholder="Enter a course code..."/><button class="ui button">Search</button></div>
